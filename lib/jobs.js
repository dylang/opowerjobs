...
var request = require('request'),
    ...
    function search(req, res) {
        ...
        jobStore.all(function (doc) {
            ...
            res.render('jobs/jobs.ejs', { locals: { active: 'jobs', jobs: search_results, query: query } });
    ...
    //app.get('/jobs',
    function jobs_index(req, res) {
        res.render('jobs/jobs.ejs', { locals: { active: 'jobs', jobs: jobs, query: '' } });
    }
    ...
    function job_location(req, res) {
        ...
        if (jobs.locations[location]) {
            ...
            res.render('jobs/jobs.ejs', { locals: { active: 'jobs', jobs: local_jobs, query: '' } });
            return true;
        }
        else
        {
    ...
    function job_location_department(req, res) {
        ...
        res.render('jobs/jobs.ejs', { locals: { active: 'jobs', jobs: dept_jobs, query: '' } });
    }
    ...
    function job(req, res) {
        ...
        jobStore.get(job_id, function(err, data) {
            res.render('jobs/job.ejs', { locals: { active: 'jobs', jobs: jobs, job: data, query: '' } });
        });
    }
    ...
    function apply(req, res) {
        ...
        jobStore.get(job_id, function(err, data) {
            res.render('jobs/apply.ejs', { locals: { active: 'jobs', jobs: jobs, job: data, query: '' } });
        });
    }
