...
function render_search(req, res, next) {
    ...
    res.render(view_dir + '/search.ejs', { locals: { jobs: jobs, query: query, search_log: jobData.search_log, currengeID: PAGE_ID } });
}
...
function render_all(req, res, next) {
    res.render(view_dir + '/all-jobs.ejs', { locals: { jobs: jobData.all_jobs, currentPageID: PAGE_ID } });
}
//app.get('/new'
...
function render_department(req, res, next) {
    ...
    if (!jobData.all_teams[department]) {
        ...
        res.render(view_dir + '/team.ejs', { locals: { header: dept_file, jobs_sf: jobs_sf, jobs_dc: jobs_dc, department: department, currentPageID: PAGE_ID } });
    }
...
function render_teams(req, res) {
    res.render(view_dir + '/teams.ejs', { locals: { currentPageID: PAGE_ID } } );
}
