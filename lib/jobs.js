...
function render_list(req, res, next) {
    ...
    if (!location && !department) {
        ...
        if (location && jobData.all_jobs.locations[location]) {
            ...
            log('show location' + location);
            res.render(view_dir + '/location.ejs', { locals: { jobs: jobs, location: location, current_page: 'locations' } });
        } else {
            ...
            res.render(view_dir + '/department.ejs', { locals: { jobs: jobs, department: department, current_page: 'departments' } });
        }
    }
...
function render_departments(req, res) {
    ...
    res.render(view_dir + '/departments.ejs', { locals: { current_page: 'departments' } } );
}
...
function createServer(options) {
    ...
    app.get('/:location_or_department', render_list);
