    ...
    function sessionHandler(req) {
        ...
        if (req.session) {
            if (!req.session.pageCount) {
                ...
                req.session.jobboard = req.query && req.query.jvs ? req.query.jvs : false;
                ...
                req.session.location && gaq_events.push("_gaq.push(['_trackEvent', 'location', '" + req.session.location + "']);");
                req.session.title && gaq_events.push("_gaq.push(['_trackEvent', 'title', '" + req.session.title + "']);");
            } else {
