...
var log = require('logging').from(__filename),
    ...
    PUBLIC_DIR  = '/Users/dylan/projects/opowerjobs/public',
    CSS_DIR     = 'public/css/',
    JS_DIR      = 'public/js/',
...
function styles(options) {
    ...
    if (compress || options.compress) {
        return '<link href="/compressed/combined.css" rel="stylesheet" type="text/css"/>';
    }
...
function scripts(options) {
    ...
    if (compress || options.compress) {
        return '<script type="text/javascript" src="/compressed/combined.js"></script>';
    }
