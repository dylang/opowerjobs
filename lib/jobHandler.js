...
function render_apply(req, res, next) {
    log('Apply', req.query, req.headers.referrer || req.headers.referer || 'No referral')
    res.render(view_dir + '/jobvite-apply.ejs', { locals: { title: 'Apply', currentPageID: PAGE_ID } });
}
