...
function add_to_search_log(query) {
...
module.exports = { all_jobs: all_jobs, all_locations: all_locations, all_departments: all_departments, all_ids: all_ids, all_urls: all_urls, all_critical: all_critical, all_new: all_new, search_log:  search_log };
