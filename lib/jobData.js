...
init();
discover_team_pages();
module.exports.data = function() { return { all_jobs: all_jobs, all_locations: all_locations, all_teams: all_teams, all_ids: all_ids, all_urls: all_urls, all_critical: all_critical, all_new: all_new, search_log:  search_log }; };
