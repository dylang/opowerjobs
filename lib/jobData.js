...
function format_description(desc) {
    ...
    var j1 = desc.split(/(The Ideal candidate)|(The Job)|(Job Description)|(About the Role)|(About the Job)|(ABOUT THE JOB)|(Core Responsibilities)|(Responsibilities)|(REQUIREMENTS)|(About You)/i);
    var j2 = [];
    var d = [];
