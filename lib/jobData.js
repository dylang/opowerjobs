...
var MINUTES_UNTIL_NEXT_UPDATE = 5; /* every 5 minutes */ // 60;  /* every hour */
...
function autoUpdate() {
    Jobvite.reload(function(new_data) {
        ...
        setTimeout(autoUpdate, MINUTES_UNTIL_NEXT_UPDATE * 60000);
    }); // TODO: Dylan, I put this "true" in here to force save the jobdata because it wasn't updating. (GM)
...
function format_description(desc) {
    ...
    var j1 = desc.split(/(The Ideal candidate)|(The Job)|(Job Description)|(About the Role)|(About the [j|J]ob)|(ABOUT THE JOB)|(Core Responsibilities)|(Responsibilities)|(REQUIREMENTS)|(About You)/);
    var j2 = [];
    var d = [];
...
module.exports = { all_jobs: all_jobs, all_locations: all_locations, all_teams: all_teams, all_ids: all_ids, all_urls: all_urls, all_critical: all_critical, all_new: all_new, search_log:  search_log };
